...
void esfera(double raio, double divb, double divh, string nome){
    ...
    for(int i = 0; i < divh; i++){
        ...
        for(int j = 0; j < divb; j++){
            ...
            file << x1 << "," << y1 << "," << z1 << endl;
            file << x1/raio << "," << y1/raio<< "," << z1/raio<< endl;
            file << j*v << "," << -i*h << "," << 0 << endl;
            file << x2 << "," << y2 << "," << z2 << endl;
            file << x2/raio << "," << y2/raio << "," << z2/raio << endl;
            file << j*v + v << "," << -i*h - h <<  "," << 0 << endl;
            file << x4 << "," << y4 << "," << z4 << endl;
            file << x4/raio << "," << y4/raio << "," << z4/raio << endl;
            file << j*v + v << "," << -i*h <<  "," << 0 << endl;

            file << x1 << "," << y1 << "," << z1 << endl;
            file << x1/raio << "," << y1/raio << "," << z1/raio << endl;
            file << j*v << "," << -i*h <<  "," << 0 << endl;
            file << x3 << "," << y3 << "," << z3 << endl;
            file << x3/raio << "," << y3/raio << "," << z3/raio << endl;
            file << j*v << "," << -i*h -h <<  "," << 0 << endl;
            file << x2 << "," << y2 << "," << z2 << endl;
            file << x2/raio << "," << y2/raio << "," << z2/raio << endl;
            file << j*v + v << "," << -i*h - h << "," << 0 << endl;
